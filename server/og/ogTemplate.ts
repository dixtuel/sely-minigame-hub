...
const GAME_CATALOG_META: Record<string, GameTheme> = {
  ...
  asteroids: {
    ...
    eyebrowEn: "VECTOR / DEFENSE",
    motto: "Parçalanan her kaya yeni bir tehdittir.",
    mottoEn: "Every shattered rock brings a new threat.",
    mechanic: "Uzay aracını yönlendir, asteroitleri ve akın eden UFO'ları parçala.",
    mechanicEn: "Pilot your ship, blast through asteroids and alien raiders.",
    controls: "Sol/Sağ: Dön, Yukarı: İtme, Boşluk: Ateş",
    controlsEn: "Left/Right: Rotate, Up: Thrust, Space: Fire",
    playTime: "3–5 dk",
    poster: "https://sely.tr/storage/asteroids-poster_6700a000.jpg",
    accent: "#E9563F",
    ink: "#293B75",
    icon: "☄",
  },
  sokoban: {
    ...
    titleEn: "SOKOBAN",
    eyebrow: "MANTIK / DEPO",
    eyebrowEn: "LOGIC / WAREHOUSE",
    motto: "Çekmek yok, sadece itebilirsin.",
    mottoEn: "No pulling allowed, push forward only.",
    mechanic: "Sandıkları depo hedeflerine it; köşelere sıkışmaktan kaçın.",
    mechanicEn: "Push crates onto storage targets without trapping corners.",
    controls: "Yön tuşları / Sanal D-Pad",
    controlsEn: "Arrow keys / Virtual D-Pad",
    playTime: "2–5 dk",
    poster: "https://sely.tr/storage/sokoban-poster_c3ef353a.jpg",
    accent: "#E5B341",
    ink: "#293B75",
    icon: "📦",
  },
  tetris: {
    ...
    title: "DÖRTYOL",
    titleEn: "TETRIS",
    eyebrow: "GEOMETRİ / HIZ",
    eyebrowEn: "GEOMETRY / SPEED",
    motto: "Hatalar üst üste biner, başarılar silinir.",
    mottoEn: "Mistakes stack up, triumphs clear away.",
    mechanic: "Düşen blokları döndürerek tam satırlar oluştur.",
    mechanicEn: "Rotate geometric falling blocks to clear complete rows.",
    controls: "Yön tuşları (Yukarı: Döndür)",
    controlsEn: "Arrow keys (Up: Rotate)",
    playTime: "3–8 dk",
    poster: "https://sely.tr/storage/tetris-poster_184bd73e.jpg",
    accent: "#296A55",
    ink: "#E9563F",
    icon: "▤",
  },
  lander: {
    ...
    title: "İNİŞ",
    titleEn: "LANDER",
    eyebrow: "YERÇEKİMİ / İNİŞ",
    eyebrowEn: "GRAVITY / TOUCHDOWN",
    motto: "Hızını düşür, açını düzelt, zemine usulca dokun.",
    mottoEn: "Cut speed, correct tilt, touch the moon softly.",
    mechanic: "Yerçekimine karşı itiş gücünü kullan, piste nazikçe in.",
    mechanicEn: "Manage lunar thrusters and touch down gently on the pad.",
    controls: "Yukarı: İtme, Sol/Sağ: Eğim",
    controlsEn: "Up: Thrust, Left/Right: Tilt",
    playTime: "2–4 dk",
    poster: "https://sely.tr/storage/lander-poster_618faf0f.jpg",
    accent: "#654169",
    ink: "#1B1A1B",
    icon: "🚀",
  },
  lightsout: {
    ...
    eyebrowEn: "GRID / TOGGLE",
    motto: "Bir düğüm yanarsa, komşuları da söner.",
    mottoEn: "Toggle a node, transform its neighbors.",
    mechanic: "Düğümlere dokunarak tüm şebekeyi karanlığa kavuştur.",
    mechanicEn: "Toggle radiant nodes until all lights on the grid extinguish.",
    controls: "Hücrelere tıkla / dokun",
    controlsEn: "Click or tap cells",
    playTime: "2–5 dk",
    poster: "https://sely.tr/storage/lightsout-poster_e388a028.jpg",
    accent: "#E5B341",
    ink: "#293B75",
    icon: "☼",
  },
  game2048: {
    ...
    title: "KARE 2048",
    titleEn: "2048",
    eyebrow: "BİRLEŞTİR / 2048",
    eyebrowEn: "MERGE / MATRIX",
    motto: "Aynı sayılar birleşir; alan daralırken sakin kal.",
    mottoEn: "Like numbers join; stay calm as the board shrinks.",
    mechanic: "Karoları kaydırarak sayıları katla, 2048 karosuna ulaş.",
    mechanicEn: "Swipe tiles to merge numbers and build the 2048 milestone.",
    controls: "Ok tuşları / Dokunmatik kaydırma",
    controlsEn: "Arrow keys / Touch swipe",
    playTime: "3–10 dk",
    poster: "https://sely.tr/storage/2048-poster_da0f7f56.jpg",
    accent: "#E9563F",
    ink: "#293B75",
    icon: "🂠",
  },
  coil: {
    num: "14", title: "COIL", titleEn: "COIL", eyebrow: "ROTA / REFLEKS", eyebrowEn: "ROUTE / REFLEX",
    motto: "Dönüşü önceden gör.", mottoEn: "See the turn before it arrives.",
    mechanic: "Günlük rotada büyü; duvara ve kendi izine çarpma.", mechanicEn: "Grow along the daily route without touching the wall or your trail.",
    controls: "Yön tuşları / WASD / Dokun", controlsEn: "Arrow keys / WASD / Tap", playTime: "2–5 dk",
    poster: "https://sely.tr/storage/coil-poster.png", accent: "#296A55", ink: "#F6F0E3", icon: "◈",
  },
  apex: {
    num: "15", title: "APEX", titleEn: "APEX", eyebrow: "YARIŞ / ÇİZGİ", eyebrowEn: "RACE / LINE",
    motto: "Çizgiyi koru, ritmi yükselt.", mottoEn: "Hold the line and raise the rhythm.",
    mechanic: "Üç şeritli parkurda engelleri akıcı biçimde geç.", mechanicEn: "Thread a three-lane track as the pace rises.",
    controls: "Sol/Sağ veya A/D / Dokun", controlsEn: "Left/Right or A/D / Tap", playTime: "2–4 dk",
    poster: "https://sely.tr/storage/apex-poster.png", accent: "#E9563F", ink: "#F6F0E3", icon: "◇",
  },
  lift: {
    num: "16", title: "LIFT", titleEn: "LIFT", eyebrow: "DİKEY / RİTİM", eyebrowEn: "VERTICAL / RHYTHM",
    motto: "Bir sonraki zemini bul.", mottoEn: "Find the next floor.",
    mechanic: "Platformlara sekerek yüksel; rota daralırken düşme.", mechanicEn: "Bounce upward as the route scrolls and tightens.",
    controls: "Sol/Sağ veya A/D / Dokun", controlsEn: "Left/Right or A/D / Tap", playTime: "2–5 dk",
    poster: "https://sely.tr/storage/lift-poster.png", accent: "#E5B341", ink: "#1B1A1B", icon: "↑",
  },
  breakline: {
    num: "17", title: "BREAKLINE", titleEn: "BREAKLINE", eyebrow: "ARK / KIRILMA", eyebrowEn: "ARC / BREAK",
    motto: "Bir hattı kır; zinciri sürdür.", mottoEn: "Break one line and keep the chain.",
    mechanic: "Topu çizgide tutup günlük tuğla dizisini temizle.", mechanicEn: "Keep the ball in play and clear the daily brick pattern.",
    controls: "Sol/Sağ veya imleç / Dokun", controlsEn: "Left/Right or cursor / Tap", playTime: "2–6 dk",
    poster: "https://sely.tr/storage/breakline-poster.png", accent: "#654169", ink: "#F6F0E3", icon: "▦",
  },
  all: {
    num: "Σ",
    title: "GENEL SIRALAMA",
    titleEn: "OVERALL RANKING",
    eyebrow: "TOPLAM / USTALIK",
    eyebrowEn: "TOTAL / MASTER",
    motto: "Tüm mini oyunların toplam gücü.",
    mottoEn: "The combined mastery of all challenges.",
    mechanic: "Tüm mini oyunlardaki en iyi skorlarının toplamı.",
    mechanicEn: "Combined total of all personal bests across SELY games.",
    controls: "Tüm oyunlar",
    controlsEn: "All games",
    playTime: "Tüm Ediyonlar",
    poster: "https://sely.tr/storage/more-games-poster_e274e5a3.jpg",
    accent: "#E9563F",
    ink: "#1B1A1B",
    icon: "👑",
  },
...
export function generateOgSvg(params: OgParams): string {
  ...
  // Keep card art self-contained: nested external SVG images are not reliably rendered
  // when the preview is decoded as an <img> and copied/rasterized through Canvas.
