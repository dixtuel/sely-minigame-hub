 ...
 * @returns {any}
 */
export function wasm_generate_arcade_config(seed, mastery, game_id) {
    const ptr0 = passStringToWasm0(game_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.wasm_generate_arcade_config(seed, mastery, ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function wasm_generate_breakline_run(seed, mastery) {
    const ret = wasm.wasm_generate_breakline_run(seed, mastery);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function wasm_generate_lander_terrain(width, height, seed) {
    const ret = wasm.wasm_generate_lander_terrain(width, height, seed);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {number} level_idx
 * @returns {any}
 */
export function wasm_parse_sokoban_level(level_idx) {
    const ret = wasm.wasm_parse_sokoban_level(level_idx);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function wasm_slide_2048_left(r0, r1, r2, r3) {
    const ret = wasm.wasm_slide_2048_left(r0, r1, r2, r3);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
