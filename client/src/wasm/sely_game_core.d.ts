 ...
 */
export function wasm_generate_arcade_config(seed: number, mastery: number, game_id: string): any;
 ...
 */
export function wasm_generate_breakline_run(seed: number, mastery: number): any;
 ...
 */
export function wasm_generate_lander_terrain(width: number, height: number, seed: number): any;
 ...
 */
export function wasm_parse_sokoban_level(level_idx: number): any;
 ...
 */
export function wasm_slide_2048_left(r0: number, r1: number, r2: number, r3: number): any;
...
export interface InitOutput {
    ...
    readonly wasm_generate_arcade_config: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly wasm_generate_breakline_run: (a: number, b: number) => [number, number, number];
    ...
    readonly wasm_generate_lander_terrain: (a: number, b: number, c: number) => [number, number, number];
    ...
    readonly wasm_parse_sokoban_level: (a: number) => [number, number, number];
    readonly wasm_segment_distance: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly wasm_slide_2048_left: (a: number, b: number, c: number, d: number) => [number, number, number];
