      ...
      <div className="vaka-modal-container">
        ...
        {!result ? (
          ...
          <div className="vaka-verdict-result-view">
            ...
            <div className="vaka-bureau-progress" role="status">
              <span>{isEn ? "BUREAU PROGRESS" : "BÜRO İLERLEMESİ"}</span>
              <strong>{completedCount} / {totalCases} {isEn ? "cases closed" : "vaka kapalı"}</strong>
              {isBureauComplete && <b>{isEn ? "ALL CASE FILES ARCHIVED" : "TÜM VAKA DOSYALARI ARŞİVLENDİ"}</b>}
            </div>
            ...
            <div className="vaka-verdict-actions-grid">
              {result.success ? (
                <>
                  {nextCase && onNextCase && !isBureauComplete && (
                    <button
                      type="button"
                  ...
                  >
                    🏢 {isBureauComplete
                      ? (isEn ? "Archive Full Bureau Run" : "Tüm Büro Sonucunu Arşivle")
