  ...
  // 2. VAKA: Köşk Yemeğinde Zehirli Kadeh
  {
    ...
    suspects: [
      ...
      },
      {
        ...
        lies: {
          level1: "Babam bana zorbalık yapardı ama onu öldürecek kadar alçalmadım.",
    ...
    suspects: [
      {
        ...
        lies: {
          level1: "Baron benim korumam altındaydı. Başarısız oldum ama ben bir suikastçı değilim.",
    ...
    suspects: [
      {
        ...
        lies: {
          level1: "Ben bir bilim insanıyım. Laboratuvardaki güvenlik açıklarını defalarca raporladım.",
